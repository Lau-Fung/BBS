...
class ImportAssignmentsController extends Controller
{
    ...
    private function translateHeader(string $column): ?string
    {
        ...
        $map = [
            ...
            'no'          => ['count','qty','العدد'],
            'year'          => ['year','موديل المركبة','موديل السنة','year model'],
            ...
            'air'            => ['air','هواء','منافخ','منافيخ'],
            'mechanic'       => ['mechanic','ميكانيك'],
            'tracking'       => ['tracking','تتبع'],
            'system_type'    => ['system type', 'نظام التتبع'],
            'calibration'    => ['calibration','المعايرة','المعيار'],
            'color'          => ['color', 'لون المركبة'],
