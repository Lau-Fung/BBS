	...
	<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
		...
		<div class="mb-8">
			<div class="flex flex-col sm:flex-row sm:justify-between">
				<div class="mb-4 sm:mb-0">
					<h1 class="text-3xl font-bold text-gray-900 dark:text-white">Sensors</h1>
					<p class="mt-2 text-gray-600 dark:text-gray-400">Manage sensor inventory and specs</p>
				</div>
				...
				<form method="GET" class="space-y-4">
					<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4">
						<div class="md:col-span-2">
							...
							<input class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white" type="text" name="filter[q]" value="{{ request('filter.q') }}" placeholder="Search Serial/BT ID / Notes...">
						</div>

						<div>
							<label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Sensor Model</label>
		...
		<div class="mb-4 flex flex-col sm:flex-row sm:items-center sm:justify-between">
			<div class="text-sm text-gray-600 dark:text-gray-400">
				Showing {{ $sensors->firstItem() ?? 0 }} to {{ $sensors->lastItem() ?? 0 }} of {{ $sensors->total() }} sensors
			</div>
		</div>
							...
							<tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-200">
								...
								<td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
									<div class="flex items-center justify-end space-x-2">
										<a href="{{ route('sensors.edit',$s) }}" class="text-blue-600 hover:text-blue-900 dark:text-blue-400 dark:hover:text-blue-300" style="padding-right: 10px;">Edit</a>
							...
							<tr>
								<td colspan="4" class="px-6 py-12 text-center">
									<div class="text-gray-500 dark:text-gray-400">
										...
										<p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Get started by creating a new sensor.</p>
										<div class="mt-6">
